  ...
  <div class="page">
    ...
    <div class="page__bd">
      ...
      <label class="weui-cell weui-check__label" v-for="(item,index) in checkboxItems" :key="index">
        ...
        <div class="weui-cell__bd">{{item.name+item.value}}</div>
      </label>
    </checkbox-group>
        <div class="weui-cell weui-cell_link">
          <div class="weui-cell__bd">添加更多</div>
      ...
      <div class="weui-cells weui-cells_after-title">
        ...
        <div class="weui-cell weui-cell_input weui-cell_vcode">
          ...
          <div class="weui-cell__ft">
            <img class="weui-vcode-img" :src="vcode" style="width: 108px"/>
          </div>
        </div>
      </div>
      ...
      <div class="weui-cells weui-cells_after-title">
        <div class="weui-cell weui-cell_switch">
          ...
          <div>{{isSwitchChange}}</div>
          <div class="weui-cell__ft">
            <switch v-bind:checked="isSwitchChange" @change = "switchChange"/>
          </div>
        </div>
      </div>
      ...
      <div class="weui-cells weui-cells_after-title">
        <div class="weui-cell weui-cell_select">
          <div class="weui-cell__bd">
            <picker @change="bindAccountChange" :range="accounts" :value="accountsIndex">
...
export default {
  ...
  methods: {
    ...
    switchChange(e) {
      this.isSwitchChange = e.mp.detail.value;
    ...
    bindCountryCodeChange(e) {
      ...
      console.info(this.countryCodesIndex)
    },
    bindAgreeChange(e) {
